# Generates scf, url & lnk payloads to put onto a smb share.
# These force authentication to an attacker machine in order to grab hashes (for example with responder).
